...
local Library = {
    ...
    BackgroundColor = Color3.fromRGB(255, 130, 0);
...
Library:GiveSignal(.DescendantRemoving:Connect(function(Instance)
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        -- 1/16/23
        -- Rewrote this to be placed inside the Library 
        ...
        SatVibMap.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                local MoveConn; local ReleaseConn;
        ...
        Library:GiveSignal(InputService.InputBegan:Connect(function(Input, gameProcessedEvent)
            if (not Picking) then
                if KeyPicker.Mode == 'Toggle' then
                    ...
                    elseif Input.UserInputType == Enum.UserInputType.Keyboard and (not gameProcessedEvent) then
