...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Ratware'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"ffffff","AccentColor":"000000","BackgroundColor":"ff8200","OutlineColor":"000000"}') },
	...
	function ThemeManager:CreateThemeManager(groupbox)
		groupbox:AddLabel('Background color'):AddDropper('BackgroundColor', { Default = self.Library.BackgroundColor });
		groupbox:AddLabel('Main color')	:AddDropper('MainColor', { Default = self.Library.MainColor });
		groupbox:AddLabel('Accent color'):AddDropper('AccentColor', { Default = self.Library.AccentColor });
		groupbox:AddLabel('Outline color'):AddDropper('OutlineColor', { Default = self.Library.OutlineColor });
		groupbox:AddLabel('Font color')	:AddDropper('FontColor', { Default = self.Library.FontColor });
